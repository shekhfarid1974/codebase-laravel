<div class="form-grid">
    ...
    <input type="hidden" name="customer_category" value="Dealer">

    <!-- Example hardcoded Customer ID field (adjust as needed) -->
    <!--
    <div class="form-group">
        <label class="form-label">Customer ID</label>
        <input type="text" name="customer_id" class="form-control" readonly value="DLR - 001">
    </div>
    -->

    <div class="form-group">
        <label class="form-label required">Owner Name <span class="sr-only">(required)</span></label>
        <input type="text" name="owner_name" class="form-control" placeholder="Enter owner name" value="{{ old('owner_name', 'John Smith') }}" required>
    </div>
