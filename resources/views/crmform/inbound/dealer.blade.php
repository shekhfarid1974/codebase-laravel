            ...
            <div class="row align-items-end">
                ...
                <div class="col-md-4">
                    <div class="form-group mb-3">
                        ...
                        <select name="dealer_interested_query[]" id="dealer_interested_query" class="form-control select2" multiple>
...
<div class="card mb-3 shadow-none bg-none">
    ...
    <div class="card-body">
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-none border">
                    <img src="https://placehold.co/600x400/EEE/31343C" class="card-img-top" alt="Premium Insecticide Pack">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-none border">
                    <img src="https://placehold.co/600x400/EEE/31343C" class="card-img-top" alt="Dealer Fungicide Collection">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-none border">
                    <img src="https://placehold.co/600x400/EEE/31343C" class="card-img-top" alt="Herbicide Bulk Pack">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-none border">
                    <img src="https://placehold.co/600x400/EEE/31343C" class="card-img-top" alt="Fertilizer Combo Pack">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-none border">
                    <img src="https://placehold.co/600x400/EEE/31343C" class="card-img-top" alt="Complete Crop Care Kit">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-none border">
                    <img src="https://placehold.co/600x400/EEE/31343C" class="card-img-top" alt="Seasonal Promotion Pack">
                    <div class="card-body d-flex flex-column">
